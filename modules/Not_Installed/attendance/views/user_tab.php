                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <h6 class="card-title mb-3">
                            <i class="ti ti-chart-bar me-2"></i> Monthly Present vs Leaves
                        </h6>
    ...
    new Chart(barCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Present',
                    data: [<?= implode(',', array_map(fn($m)=> (int)$matrix['P'][$m], range(1,12))) ?>]
                },
                {
                    label: 'Leaves (L+M+S)',
                    data: [<?= implode(',', array_map(fn($m)=> (int)$matrix['L'][$m] + (int)$matrix['M'][$m] + (int)$matrix['S'][$m], range(1,12))) ?>]
                }
            ]
        },
        options: {
