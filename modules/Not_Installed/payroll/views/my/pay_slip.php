...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between bg-light-secondary page-header gap-3 px-3 py-1 mb-3 rounded-3 shadow-sm">
      <div class="d-flex align-items-center gap-3 flex-wrap">
        <h1 class="h6 header-title"><?= $page_title ?> > <span class="text-muted small text-primary"><?= $e($employee_name) ?> (<?= $emp_code ? $e($emp_code) : '—' ?>)</span></h1>
      </div>
    
      <div class="d-flex align-items-center gap-2 flex-wrap">
        <span class="text-muted small text-primary"><strong>Payslip for:</strong> Current Payroll Month</span>
      </div>
    </div>
