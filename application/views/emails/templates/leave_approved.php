...
<head>
  <meta charset="utf-8">
  <title><?= html_escape($subject ?? 'Leave Approved') ?></title>
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0"
        ...
        <!-- Header -->
        <tr>
          <td style="padding:16px 20px;background:#16a34a;color:#ffffff;
        ...
        <tr>
          <td style="padding:24px 20px;font-family:Arial,Helvetica,sans-serif;color:#334155;">
            ...
            <h2 style="margin:0 0 12px 0;font-size:18px;color:#065f46;">
              Your leave request has been approved 🎉
            </h2>

            <p style="margin:0 0 16px 0;line-height:1.55;color:#374151;">
              We’re pleased to inform you that your leave request has been <strong>approved</strong>.
            </p>
