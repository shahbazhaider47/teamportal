...
<head>
  ...
  <title>Portal Login | RCM Centric</title>
  ...
  <div class="login-wrapper">
    ...
    <div class="login-header text-center">
      ...
      <div class="login-body">
        ...
        <?php echo form_open('authentication/login', ['class' => 'needs-validation', 'novalidate' => '']); ?>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="password" id="password" name="password" class="form-control <?= form_error('password') ? 'is-invalid' : '' ?>" placeholder="Enter your password" required>
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?php echo site_url('authentication/forgot_password'); ?>" class="forgot-link">Forgot Password?</a>
</div>
      ...
      form.addEventListener('submit', function (event) {
        ...
        if (recaptchaEnabled && recaptchaVersion === 'v3' && recaptchaSiteKey) {
          ...
          if (typeof grecaptcha !== 'undefined') {
            ...
            // Fallback: block submit if reCAPTCHA script failed to load
