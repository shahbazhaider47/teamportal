...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between bg-light-secondary page-header gap-3 px-3 py-1 mb-3 rounded-3 shadow-sm">
      ...
      <div class="d-flex align-items-center gap-2 flex-wrap">
        ...
        <?php if (!empty($contract) && !empty($contract['id'])): ?>
            <a href="<?= site_url('contracts/my_contract/' . (int)$contract['id']); ?>"
               class="btn btn-outline-primary btn-header">
                <i class="ti ti-files"></i> My Contract
            </a>
        <?php else: ?>
            <!-- Optional: disabled state if no contract -->
            <button type="button" class="btn btn-outline-secondary btn-header" disabled>
                <i class="ti ti-files"></i> My Contract
            </button>
        <?php endif; ?>
        ...
        <a href="<?= site_url('users/settings') ?>"
           class="btn btn-outline-primary btn-header">
            ...
            <div class="card border-0">
                ...
                <div class="mt-1">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value"><?= !empty($user['emp_dob']) ? date('l, d F Y', strtotime($user['emp_dob'])) : '-' ?></div>
                    </div>
                    <div class="info-row">
            ...
            <div class="section-card">
                ...
                <div class="card-body pt-2 pb-2">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value"><?= !empty($user['emp_joining']) ? date('l, d F Y', strtotime($user['emp_joining'])) : '-' ?></div>
                    </div>
                    <div class="info-row">
                ...
                <div class="card-body pt-2 pb-2">
                    ...
                    <div class="info-row">
                      ...
                      <div class="info-value d-flex align-items-center gap-2">
                        <span class="salary-mask" data-actual="<?= html_escape(get_base_currency_symbol() . number_format($user['joining_salary'] ?? 0)) ?>">****</span>
                      </div>
                    </div>
                    ...
                    <div class="info-row">
                      ...
                      <div class="info-value d-flex align-items-center gap-2">
                        <span class="salary-mask" data-actual="<?= html_escape(get_base_currency_symbol() . number_format($user['current_salary'] ?? 0)) ?>">****</span>
                      </div>
                    </div>
                    <div class="info-row">
                  ...
                  <div class="info-row">
                    ...
                    <div class="info-value">
                      <?php if (isset($exit['final_settlement_amount']) && $exit['final_settlement_amount'] !== ''): ?>
                        <?= html_escape(get_base_currency_symbol()) . number_format((float)$exit['final_settlement_amount']) ?>
                      <?php else: ?>
                        —
                      <?php endif; ?>
                    </div>
                ...
                <ul class="nav nav-tabs tab-primary bg-primary p-1 mb-2 small" id="profileTabs" role="tablist" style="--bs-nav-link-padding-y: 0.25rem; --bs-nav-link-padding-x: 0.5rem; font-size: 0.85rem;">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active py-1 px-2" id="teams-tab" data-bs-toggle="tab"
                     ...
                     aria-selected="false"><i class="ti ti-users me-1"></i>Reporting Team</button>
                  </li>
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link py-1 px-2" id="documents-tab" data-bs-toggle="tab"
                     ...
                     aria-selected="false"><i class="ti ti-file me-1"></i>Documents</button>
                  </li>
