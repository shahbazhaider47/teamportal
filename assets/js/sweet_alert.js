document.addEventListener('DOMContentLoaded', function() {
    if (window.SWEETALERT_TRIGGER) {
        switch (window.SWEETALERT_TRIGGER) {
            case "team_updated":
                swal({
                    title: "Success!",
            ...
            default:
                // fallback: try button click for legacy/demo
                var btn = document.getElementById(window.SWEETALERT_TRIGGER);
                if (btn) btn.click();
        }
    }
});
