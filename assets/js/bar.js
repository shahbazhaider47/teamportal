...
colors: [getLocalStorageItem('color-secondary','#74788D'),'#0FB450'],
  dataLabels: {
    enabled: true,
    offsetX: -6,
    style: {
...
colors: ['#056464','#74788D','#0FB450','#EA5659','#FAC10F'],
  };
...
colors: [getLocalStorageItem('color-primary','#056464')],
  legend: {
    ...
    markers: {
      fillColors: [getLocalStorageItem('color-primary','#056464'), getLocalStorageItem('color-secondary','#74788D')]
    }
  }
  };
...
colors: ['#EA5659','#FAC10F','#3C91F3','#ACB8C8','#231928'],
  states: {
    hover: {
      filter: 'none'
    }
