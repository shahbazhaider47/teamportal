...
var data = [
  ...
  var colors = [getLocalStorageItem('color-primary','#056464'),getLocalStorageItem('color-secondary','#74788D'),"#0FB450","#EA5659","#FAC10F","#3C91F3","#ACB8C8","#231928"]
    ...
    heatmap: {
      ...
      colorScale: {
        ranges: [{
            ...
            to: 5,
            name: 'low',
            color: getLocalStorageItem('color-primary','#056464')
          },
          {
            from: 6,
            to: 20,
            name: 'medium',
            color: getLocalStorageItem('color-secondary','#74788D')
          },
          {
            from: 21,
            to: 45,
